...
extension UIApplication {
    ...
    func setOwnerTab() {
        if let homeNavigation = UIStoryboard.main.instantiateViewController(withClass: OwnerNav.self) {
            self.setRootController(for: homeNavigation)
        }
    }
    
    func setWalkerTab() {
        if let homeNavigation = UIStoryboard.main.instantiateViewController(withClass: WalkerNav.self) {
            self.setRootController(for: homeNavigation)
        }
    }
